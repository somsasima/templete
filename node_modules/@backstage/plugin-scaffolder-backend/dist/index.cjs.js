...
var winston2 = _interopDefault(require('winston'));
...
const makeLogStream = (meta) => {
  ...
  const logger = winston2.createLogger({
    ...
    format: winston2.format.combine(winston2.format.colorize(), winston2.format.timestamp(), winston2.format.simple()),
    defaultMeta: meta
  });
  logger.add(new winston2.transports.Stream({stream: stream2}));
  return {
    log,
    stream: stream2,
    logger
